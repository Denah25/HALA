...
<body>
	...
	<div class="banner-top">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@TRINITY.COM</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+254 777329840</li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">TRINITY
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>TRIN <span>ITY</span></h4>
					<img src="images/1.jpg" alt=" " class="img-responsive">
					<h5>We know what you love</h5>
					<p>Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Trinity Hotel one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
				</div>
			</div>
		</div>
	</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">TRINITY</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">CITY VIEW</h4>
							<span class="cbp-ig-category">TRINITY</span>
						</div>
					</li>
					<li>
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About Our TRINITY</h3>
				<p class="about-para-w3ls">Trinity Hotel is a 5 star hotel located at the coast of Kenya.</p>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong>+254 777328903</p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@TRINITY.COM</a></p>
				<p class="contact-agile1"><strong>Address :</strong> Old Town, Mombasa, Kenya</p>
	...
	<!-- /contact -->
	<div class="copy">
		<p>© 2017 TRINITY . All Rights Reserved | Design by <a href="index.php">TRINITY</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
